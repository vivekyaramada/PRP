 ...
 */
@Entity
@Table(name = "prp_covg_bkup", schema = "", catalog = "prp")
@IdClass(PrpCovgBkupEntityPK.class)
public class PrpCovgBkupEntity {
    private String hicn;
    ...
    @Basic
    @Column(name = "CVG_FRZ_DT")
    public Date getCvgFrzDt() {
        return cvgFrzDt;
    }

    public void setCvgFrzDt(Date cvgFrzDt) {
        this.cvgFrzDt = cvgFrzDt;
    }
    ...
    public boolean equals(Object o) {
        ...
        PrpCovgBkupEntity that = (PrpCovgBkupEntity) o;
        ...
        if (cvgFrzDt != null ? !cvgFrzDt.equals(that.cvgFrzDt) : that.cvgFrzDt != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (cvgFrzDt != null ? cvgFrzDt.hashCode() : 0);
        return result;
    }
}
