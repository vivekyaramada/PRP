 ...
 */
@Entity
@Table(name = "prp_intcvg_stat", schema = "", catalog = "prp")
@IdClass(PrpIntcvgStatEntityPK.class)
public class PrpIntcvgStatEntity {
    private int beneId;
    ...
    public boolean equals(Object o) {
        ...
        PrpIntcvgStatEntity that = (PrpIntcvgStatEntity) o;
