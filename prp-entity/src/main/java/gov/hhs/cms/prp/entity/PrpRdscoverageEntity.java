 ...
 */
@Entity
@Table(name = "prp_rdscoverage", schema = "", catalog = "prp")
@IdClass(PrpRdscoverageEntityPK.class)
public class PrpRdscoverageEntity {
    private int beneId;
    ...
    public boolean equals(Object o) {
        ...
        PrpRdscoverageEntity that = (PrpRdscoverageEntity) o;
