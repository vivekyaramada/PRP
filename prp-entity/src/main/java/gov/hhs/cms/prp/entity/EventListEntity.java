...
public class EventListEntity {
    ...
    private final static Logger LOGGER = Logger.getLogger(EventListEntity.class.getName());
    ...
    public ArrayList getEvents(String keyword) {
        ...
        try {
            String urlString = "http://localhost:9073/prp-ws/hello/events/" + keyword;
            URL url = new URL(urlString);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "events/json");
