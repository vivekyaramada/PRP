 ...
 */
@Entity
@Table(name = "prp_intrmdt_cvg", schema = "", catalog = "prp")
@IdClass(PrpIntrmdtCvgEntityPK.class)
public class PrpIntrmdtCvgEntity {
    private int beneId;
    ...
    public boolean equals(Object o) {
        ...
        PrpIntrmdtCvgEntity that = (PrpIntrmdtCvgEntity) o;
