 ...
 */
@Entity
@Table(name = "prp_extcvg_stat", schema = "", catalog = "prp")
@IdClass(PrpExtcvgStatEntityPK.class)
public class PrpExtcvgStatEntity {
    private int beneId;
    ...
    public boolean equals(Object o) {
        ...
        PrpExtcvgStatEntity that = (PrpExtcvgStatEntity) o;
