 ...
 */
@Entity
@Table(name = "prp_retlisthist", schema = "", catalog = "prp")
@IdClass(PrpRetlisthistEntityPK.class)
public class PrpRetlisthistEntity {
    ...
    public boolean equals(Object o) {
        ...
        PrpRetlisthistEntity that = (PrpRetlisthistEntity) o;
