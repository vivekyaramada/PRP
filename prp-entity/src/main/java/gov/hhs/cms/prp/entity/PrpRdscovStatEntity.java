 ...
 */
@Entity
@Table(name = "prp_rdscov_stat", schema = "", catalog = "prp")
@IdClass(PrpRdscovStatEntityPK.class)
public class PrpRdscovStatEntity {
    private int beneId;
    ...
    public boolean equals(Object o) {
        ...
        PrpRdscovStatEntity that = (PrpRdscovStatEntity) o;
