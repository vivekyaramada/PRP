 ...
 */
@Entity
@Table(name = "prp_cvg_hs", schema = "", catalog = "prp")
@IdClass(PrpCvgHsEntityPK.class)
public class PrpCvgHsEntity {
    private int beneId;
    private int sequence;
    private Timestamp termTs;
    private String updtTypeCd;
    private String updtSrcCd;
    ...
    @Basic
    @Column(name = "UPDT_TYPE_CD")
    public String getUpdtTypeCd() {
        return updtTypeCd;
    }

    public void setUpdtTypeCd(String updtTypeCd) {
        this.updtTypeCd = updtTypeCd;
    }

    @Basic
    @Column(name = "UPDT_SRC_CD")
    public String getUpdtSrcCd() {
        return updtSrcCd;
    }

    public void setUpdtSrcCd(String updtSrcCd) {
        this.updtSrcCd = updtSrcCd;
    }
    ...
    public boolean equals(Object o) {
        ...
        PrpCvgHsEntity that = (PrpCvgHsEntity) o;
        ...
        if (updtTypeCd != null ? !updtTypeCd.equals(that.updtTypeCd) : that.updtTypeCd != null) return false;
        if (updtSrcCd != null ? !updtSrcCd.equals(that.updtSrcCd) : that.updtSrcCd != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (updtTypeCd != null ? updtTypeCd.hashCode() : 0);
        result = 31 * result + (updtSrcCd != null ? updtSrcCd.hashCode() : 0);
